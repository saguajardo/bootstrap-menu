...
namespace Saguajardo\BootstrapMenu\Commands;
...
class MakeMenuCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:menu {--views : Only scaffold the authentication views}';
    ...
    public function fire()
    {
        ...
        file_put_contents(
            ...
            file_get_contents(__DIR__.'/stubs/make/
                '),
            FILE_APPEND
        );
        // }

        $this->comment('Menu scaffolding generated successfully!');
    }
